...
const ifgDiskurs: BodyBlock = {
  ...
  perspektiven: [
    ...
    },
    {
      ...
      quelle: {
        titel: 'ZDFheute — Warken verteidigt Schwärzungen im Maskenbericht',
        url: 'https://www.zdfheute.de/politik/deutschland/warken-masken-beschaffung-corona-spahn-schwaerzungen-bericht-100.html',
        herausgeber: 'ZDF',
      },
    },
    {
...
const ifgArticle: Article = {
  ...
  body: [
    ...
    ifgDiskurs,
    {
      _type: 'quellenNote',
      _key: key(),
      text: 'Reform-Eckpunkte und Verfahren: Koalitionsausschuss-Beschluss vom 2. Juli 2026 (Punkt 32), Koalitionsvertrag 2025, BT-Drucksache 21/6207, Parlamentsdatenbank DIP. Antragsstatistik: BMI (Statistik der IFG-Anträge 2006 bis 2025). Vergleiche: Global Right to Information Rating (Centre for Law and Democracy / Access Info Europe) und Transparenzranking (Open Knowledge Foundation / Mehr Demokratie). Nutzung und Recherchen: FragDenStaat; Umfrage und Positionen: BfDI. Fallbeispiel Maskenbeschaffung: ZDF, FragDenStaat und Bundesrechnungshof. Weitere Positionen paraphrasiert nach Bundesregierung, Bundesgesundheitsministerium, Speyer-Evaluation, dju/DJV und Transparency International Deutschland. Stand: 5. Juli 2026; das Vorhaben ist ein Koalitionsbeschluss, der Gesetzentwurf steht aus.',
      quelle: {
...
const foerderungLinie: BodyBlock = {
  _type: 'visualisierungBlock',
  _key: key(),
  visualisierung: {
    titel: 'Heimische Erdgasförderung 2021 bis 2025',
    typ: 'linie',
    beschreibung:
    ...
    encoding: { xFeld: 'jahr', yFeld: 'menge' },
    datensatz: {
      titel: 'Heimische Erdgasförderung 2021 bis 2025 (Rohgas in Feldesqualität)',
      quelle: {
        titel: 'LBEG — Jahresberichte Erdöl und Erdgas in der Bundesrepublik Deutschland',
        url: 'https://www.lbeg.niedersachsen.de/erdoel-erdgas-jahresbericht/jahresbericht-erdol-und-erdgas-in-der-bundesrepublik-deutschland-936.html',
        herausgeber: 'Landesamt für Bergbau, Energie und Geologie (LBEG)',
      },
      spalten: [
        { name: 'jahr', typ: 'string' },
        { name: 'menge', typ: 'number', einheit: 'Mrd. m³' },
      ],
      daten: [
        { jahr: '2021', menge: 5.7 },
        { jahr: '2022', menge: 5.2 },
...
const foerderungTabelle: BodyBlock = {
  _type: 'datentabelleBlock',
  _key: key(),
  caption:
  ...
  datensatz: {
    titel: 'Heimische Erdgasförderung in Zahlen (2025)',
    quelle: {
      titel: 'LBEG — Jahresbericht Erdöl und Erdgas 2025',
      url: 'https://www.lbeg.niedersachsen.de/aktuelles/pressemitteilungen/erdgasforderung-in-deutschland-erstmals-nicht-rucklaufig-lbeg-legt-aktuellen-jahresbericht-erdol-und-erdgas-vor-252550.html',
      herausgeber: 'Landesamt für Bergbau, Energie und Geologie (LBEG)',
    },
    spalten: [
      { name: 'Kennzahl', typ: 'string' },
    ...
    daten: [
      { Kennzahl: 'Förderung 2025', Wert: '4,5 Mrd. m³ (plus 2 %, erstmals seit 2003 kein Rückgang)' },
      { Kennzahl: 'Anteil am deutschen Bedarf', Wert: 'rund 5 bis 6 % (Näherung, siehe Methodik)' },
      { Kennzahl: 'Anteil Niedersachsens', Wert: '98 % der Förderung' },
      { Kennzahl: 'Neues Nordseefeld N05-A', Wert: 'rund 4 % der Förderung' },
    ],
  },
};

const potenzialTabelle: BodyBlock = {
  _type: 'datentabelleBlock',
  _key: key(),
  caption:
    'Drei Größen, die in der Debatte häufig vermischt werden: ein Vorrat, ein geologisches Potenzial und eine jährliche Förderrate. Sie sind nicht ineinander umrechenbar. Quellen: LBEG (Reserven), BGR (NiKo-Abschlussbericht 2016), Kümpel für die Friedrich-Naumann-Stiftung (2026).',
  datensatz: {
    titel: 'Reserven, Potenzial und Förderrate im Vergleich',
    quelle: {
      titel: 'BGR — NiKo: Erdöl und Erdgas aus Tongesteinen, Potenziale für Deutschland (Abschlussbericht 2016)',
      url: 'https://www.bgr.bund.de/DE/Themen/Rohstoffe/Projekte/Energierohstoffe_abgeschlossen/NIKO/NIKO_projektbeschreibung.html',
      herausgeber: 'Bundesanstalt für Geowissenschaften und Rohstoffe (BGR)',
    },
    spalten: [
      { name: 'Größe', typ: 'string' },
      { name: 'Wert', typ: 'string' },
      { name: 'Was sie aussagt', typ: 'string' },
    ],
    daten: [
      {
        'Größe': 'Konventionelle Reserven (LBEG, 31.12.2025)',
        Wert: '33,3 Mrd. m³',
        'Was sie aussagt': 'Vorrat aus konventionellen Lagerstätten, rechnerisch rund 7 Jahre; Schiefergas ist darin nicht enthalten',
      },
      {
        'Größe': 'Schiefergas, technisch förderbar (BGR, 2016)',
        Wert: '320 bis 2.030 Mrd. m³',
        'Was sie aussagt': 'Amtliche Potenzialspanne für den Untergrund, weder Reserve noch Jahresmenge',
      },
      {
        'Größe': 'Mögliche Förderrate (Kümpel, Friedrich-Naumann-Stiftung, 2026)',
        Wert: 'rund 20 Mrd. m³ pro Jahr',
        'Was sie aussagt': 'Schätzung einer Auftragsstudie, entspräche rund 23 % des heutigen Bedarfs; keine genehmigte oder geförderte Menge',
      },
    ],
  },
};

const frackingDiskurs: BodyBlock = {
  _type: 'diskursBlock',
  _key: key(),
  titel: 'Wie über Fracking in Deutschland gestritten wird',
  frage: 'Soll Deutschland die Förderung von Schiefergas erlauben, und was brächte sie?',
  einleitung:
  ...
  perspektiven: [
    {
      label: 'Beraterkreis des Bundeswirtschaftsministeriums (Kurzgutachten, März 2026)',
      aussage:
      ...
      quelle: {
        titel: 'Reiche-Berater bringen heimisches Fracking ins Spiel (zum Kurzgutachten von Grimm, Haucap, Kolev und Wieland, März 2026)',
        url: 'https://www.tagesspiegel.de/wirtschaft/wegen-steigender-energiepreise-reiche-berater-bringen-heimisches-fracking-ins-spiel-15352258.html',
        herausgeber: 'Der Tagesspiegel',
      },
    },
    {
      label: 'Bundeswirtschaftsministerium (geltende Rechtslage)',
      aussage:
      ...
      quelle: {
        titel: 'BMWE — Fracking: Rechtslage und Regelungspaket',
        url: 'https://www.bundeswirtschaftsministerium.de/Redaktion/DE/Artikel/Industrie/fracking.html',
        herausgeber: 'Bundesministerium für Wirtschaft und Energie (BMWE)',
      },
    },
    {
      label: 'Bundesverband Erdgas, Erdöl und Geoenergie (Branchenverband)',
      aussage:
      ...
      quelle: {
        titel: 'BVEG — Fracking in Deutschland (Verbandsposition)',
        url: 'https://www.bveg.de/die-branche/erdgas-und-erdoel-in-deutschland/fracking-in-deutschland/',
        herausgeber: 'Bundesverband Erdgas, Erdöl und Geoenergie (BVEG)',
      },
    },
    {
      label: 'Expertenkommission Fracking (Bericht 2025 an den Bundestag)',
      aussage:
      ...
      quelle: {
        titel: 'Bericht der Expertenkommission Fracking 2025 (Bundestags-Drucksache 21/850)',
        url: 'https://dserver.bundestag.de/btd/21/008/2100850.pdf',
        herausgeber: 'Deutscher Bundestag / Expertenkommission Fracking nach § 13a WHG',
      },
    },
    {
      label: 'Umweltbundesamt (Einschätzung von Februar 2023)',
      aussage:
      ...
      quelle: {
        titel: 'UBA — Fracking zur Schiefergasförderung in Deutschland: eine energie- und umweltfachliche Einschätzung (2023)',
        url: 'https://www.umweltbundesamt.de/publikationen/fracking-zur-schiefergasfoerderung-in-deutschland',
        herausgeber: 'Umweltbundesamt (UBA)',
      },
    },
    {
      label: 'Deutsche Umwelthilfe (laufende Kampagne)',
      aussage:
...
const frackingArticle: Article = {
  ...
  themen: [
    { name: 'Energiepolitik', slug: 'energiepolitik' },
    { name: 'Fracking', slug: 'fracking' },
  ],
  autoren: [{ name: 'GURT-Redaktion', rolle: 'Datenjournalismus' }],
  methodik:
    'Förderung und Reserven: LBEG, Jahresberichte Erdöl und Erdgas (Landesamt für Bergbau, Energie und Geologie, Niedersachsen), Basis Rohgas in Feldesqualität. Förderung 2025: 4,5 Mrd. m³, plus 2 % gegenüber 2024, erstmals seit 2003 kein Rückgang. Die Reihe im Liniendiagramm (2021: 5,7; 2022: 5,2; 2023: 4,6; 2024: 4,4; 2025: 4,5 Mrd. m³) folgt den Jahresberichten: Die Werte für 2022 (minus 7,9 %), 2023 (minus 12,6 %), 2024 (minus 3,7 %) und 2025 (plus 2 %) sind dort unmittelbar genannt; der Wert für 2021 ist aus der für 2022 berichteten Veränderungsrate abgeleitet. Reserven (sicher und wahrscheinlich) zum 31.12.2025: 33,3 Mrd. m³, minus 4,1 %; die rechnerische Reichweite von rund sieben Jahren (33,3 geteilt durch 4,5) unterstellt konstante Förderung und keine neuen Funde. Wichtige Abgrenzung: Diese Reserven stammen aus konventionellen Lagerstätten und enthalten kein Schiefergas. Bedarfsanteil: Der Bedarf wird vom BDEW in Kilowattstunden erhoben (875 Mrd. kWh für 2025, plus 3,7 %). Die Umrechnung in Kubikmeter hängt von Brennwert und Gasqualität ab; bei 10 bis 11 kWh je Kubikmeter ergeben sich rund 80 bis 88 Mrd. m³ und damit ein heimischer Anteil von rund fünf bis sechs Prozent. Der Anteil überbrückt damit zwei Bemessungsgrundlagen (Rohgas in Feldesqualität gegen den aus Kilowattstunden zurückgerechneten Bedarf) und ist eine Näherung, keine exakte Quote; der BVEG nennt 4,8 Prozent. Drei Größen sind zu trennen: Reserven (konventioneller Vorrat), Ressourcen beziehungsweise Potenzial (geologisch vorhandene, technisch förderbare Menge) und Förderrate (Menge pro Jahr). Schiefergas-Potenzial: BGR, Projekt NiKo („Erdöl und Erdgas aus Tongesteinen, Potenziale für Deutschland“), Abschlussbericht 2016: 320 bis 2.030 Mrd. m³ nach damaligem Stand der Technik förderbar; das ist eine Ressourcenmenge, keine Jahresmenge. Die Rate von rund 20 Mrd. m³ pro Jahr stammt aus einer Auftragsstudie von Hans-Joachim Kümpel (ehemaliger BGR-Präsident) für die FDP-nahe Friedrich-Naumann-Stiftung für die Freiheit (Juni 2026); sie entspräche rund 23 Prozent des heutigen Bedarfs und ist eine Interessenposition, keine genehmigte oder geförderte Menge. Rechtsstand: Regelungspaket seit 11.2.2017; kommerzielle Fracking-Vorhaben in unkonventionellen Lagerstätten (Schiefer-, Ton-, Mergel- und Kohleflözgestein) sind unzulässig, in konventionellen Lagerstätten ist Fracking zulässig und wurde über Jahrzehnte angewandt, seit einigen Jahren gibt es jedoch keine Vorhaben mehr; bis zu vier wissenschaftlich begleitete Erprobungsmaßnahmen wären zulässig, die Evaluierung 2021 stellte fest, dass es weder im unkonventionellen noch im konventionellen Bereich Fracking-Vorhaben gegeben hat. Expertenkommission Fracking: Bericht 2025 an den Bundestag (Drucksache 21/850), Stand von Wissenschaft und Technik gegenüber 2021 unverändert. Importe: Bundesnetzagentur, Rückblick Gasversorgung 2025 (Gesamtimporte 1.031 TWh gegenüber 864 TWh im Jahr 2024; über die LNG-Terminals Wilhelmshaven, Brunsbüttel, Lubmin und Mukran 106 TWh, das sind 10,3 % der Importe; der Pipeline-Anteil von knapp 90 % folgt daraus rechnerisch). Der US-Anteil an den LNG-Importen von rund 96 % stammt vom BDEW. Eine Aufteilung der Importe nach Lieferländern ist auf der Seite der Bundesnetzagentur nur als Grafik ausgewiesen und wird hier deshalb nicht beziffert. Positionen sind paraphrasiert, je mit Quelle und mit Jahr beziehungsweise Rolle ausgewiesen; das wörtliche Zitat des LBEG-Präsidenten stammt aus der Pressemitteilung zum Jahresbericht. Online-Quellen im Juli 2026 abgerufen.',
  body: [
    block('h2', 'Worum es geht'),
    block(
      'normal',
    ...
    block('h2', 'Wie viel Gas Deutschland noch selbst fördert'),
    block(
      'normal',
    ...
    ),
    {
      _type: 'zitatBlock',
      _key: key(),
      zitat: 'Seit 2003 haben wir einen stetigen Rückgang der Erdgasförderzahlen gesehen.',
      quelle: {
        titel: 'Carsten Mühlenmeier (Präsident des LBEG), Pressemitteilung zum Jahresbericht Erdöl und Erdgas 2025',
        url: 'https://www.lbeg.niedersachsen.de/aktuelles/pressemitteilungen/erdgasforderung-in-deutschland-erstmals-nicht-rucklaufig-lbeg-legt-aktuellen-jahresbericht-erdol-und-erdgas-vor-252550.html',
        herausgeber: 'Landesamt für Bergbau, Energie und Geologie (LBEG)',
      },
    },
    foerderungLinie,
    foerderungTabelle,
    block('h2', 'Was im Untergrund liegt, und was das heißt'),
    block(
      'normal',
    ...
    block('h2', 'Was erlaubt ist und was nicht'),
    block(
      'normal',
    ...
    block('h2', 'Der Blick auf die Importe'),
    block(
      'normal',
    ...
    frackingDiskurs,
    {
      _type: 'quellenNote',
      _key: key(),
      text: 'Daten: LBEG, Jahresberichte Erdöl und Erdgas (Förderung 2021 bis 2025, Reserven, Regionalanteil, Feld N05-A; Basis Rohgas in Feldesqualität), BDEW (Erdgasbedarf 875 Mrd. kWh für 2025 und US-Anteil an den LNG-Importen), Bundesnetzagentur (Rückblick Gasversorgung 2025: Gesamtimporte, Lieferländer, LNG-Anteil), BGR (NiKo-Abschlussbericht 2016: Schiefergas-Potenzial 320 bis 2.030 Mrd. m³), Kümpel für die Friedrich-Naumann-Stiftung für die Freiheit (2026: Förderrate von rund 20 Mrd. m³ pro Jahr, Auftragsstudie). Rechtsstand: Bundeswirtschaftsministerium (Regelungspaket seit 11.2.2017, Verbot kommerzieller Vorhaben in unkonventionellen Lagerstätten, vier mögliche Erprobungsmaßnahmen, Evaluierung 2021) und Expertenkommission Fracking (Bericht 2025, Bundestags-Drucksache 21/850). Positionen paraphrasiert nach dem Beraterkreis des Bundeswirtschaftsministeriums (Kurzgutachten März 2026), dem Bundeswirtschaftsministerium, dem BVEG (Verbandsposition), der Expertenkommission Fracking, dem Umweltbundesamt (Einschätzung 2023) und der Deutschen Umwelthilfe (Kampagne). Das wörtliche Zitat stammt vom LBEG-Präsidenten aus der Pressemitteilung zum Jahresbericht. Reichweite und Bedarfsanteil sind abgeleitet und überbrücken zwei Bemessungsgrundlagen; Definitionen von Reserven, Ressourcen und Förderrate siehe Methodik.',
      quelle: {
        titel: 'LBEG — Jahresbericht Erdöl und Erdgas 2025',
        url: 'https://www.lbeg.niedersachsen.de/aktuelles/pressemitteilungen/erdgasforderung-in-deutschland-erstmals-nicht-rucklaufig-lbeg-legt-aktuellen-jahresbericht-erdol-und-erdgas-vor-252550.html',
      },
...
const dezilBelastungLinie: BodyBlock = {
  ...
  visualisierung: {
    ...
    typ: 'linie',
    beschreibung:
      'Liniendiagramm der gesamten Steuerlast (direkte und indirekte Steuern, ohne Sozialbeiträge) in Prozent des Haushaltsbruttoeinkommens, für die zehn Einkommensdezile. Das unterste Zehntel zahlt 23,1 Prozent, das zweite und dritte nur noch 18,6 und 17,5 Prozent: In den unteren Dezilen sinkt die Belastung mit steigendem Einkommen, wirkt also regressiv. Erst danach steigt sie wieder an, mit einer kleinen Delle im fünften Zehntel (18,0, dann 17,8 Prozent), bis auf 31,2 Prozent im obersten Zehntel. Über alle Dezile hinweg ist die Belastung damit nur schwach progressiv; der einkommensgewichtete Durchschnitt über alle Haushalte liegt bei 24,1 Prozent und ist deshalb nicht das einfache Mittel der zehn Dezilwerte. Ursache der hohen Last unten sind die indirekten Steuern, die am Konsum hängen und niedrige Einkommen anteilig stärker treffen.',
    caption:
      'Steuern insgesamt (direkte und indirekte, ohne Sozialbeiträge) in Prozent des Haushaltsbruttoeinkommens je Einkommensdezil; Durchschnitt über alle Haushalte 24,1 Prozent (einkommensgewichtet, nicht das einfache Mittel der zehn Dezilwerte). Die fallenden Werte in den unteren Dezilen sind die Regressivität, von der im Text die Rede ist. Wer indirekte und Unternehmensteuern wirtschaftlich trägt, beruht auf Überwälzungsannahmen. Die Werte sind ein Jahresquerschnitt; über einen längeren Zeitraum betrachtet sind indirekte Steuern laut Studie weniger regressiv, als es hier den Anschein hat. Datenbasis auf 2015 fortgeschrieben, Konsumdaten aus der Einkommens- und Verbrauchsstichprobe 2008. Quelle: DIW Wochenbericht 51+52/2016 (Bach, Beznoska, Steiner; gefördert von der gewerkschaftsnahen Hans-Böckler-Stiftung), Tabelle 3.',
  ...
  datensatz: {
    ...
    daten: [
      ...
      },
      {
        ...
        Befund: 'Weitgehend netto Transferempfänger unterhalb der Mitte (je nach Rentenkonvention die untersten sechs, drei oder zwei Dezile); effektive Grenzbelastung in der Mitte rund 50 %, höher als bei hohen und am höchsten bei niedrigen Einkommen',
...
const kennzahlenTabelle: BodyBlock = {
  ...
  _key: key(),
  caption:
    'Kennzahlen zur Einkommensteuer für das Jahr 2022, jeweils mit Bezugsgröße. Quellen: Statistisches Bundesamt, Pressemitteilung Nr. 194 vom 10. Juni 2026 (Spitzensteuersatz-Zahler, Einkünfte- und Aufkommensanteil) sowie Destatis-Tabellen zur Lohn- und Einkommensteuerstatistik 2022 zum Gesamtbetrag der Einkünfte und zu den Einkommensmillionären (Steuerpflichtige insgesamt, Gesamteinkünfte, Millionäre).',
  datensatz: {
    titel: 'Die Einkommensteuer 2022 in Zahlen',
    quelle: {
      titel: 'Statistisches Bundesamt — Pressemitteilung Nr. 194 vom 10. Juni 2026 sowie Tabellen zur Lohn- und Einkommensteuerstatistik 2022 (Gesamtbetrag der Einkünfte; Einkommensmillionäre)',
    ...
    daten: [
      ...
      { Kennzahl: 'Deren Anteil an den Gesamteinkünften', Wert: 'knapp 30 % (621 Mrd. €)', 'Bezugsgröße und Datenjahr': 'Gesamteinkünfte aller Steuerpflichtigen (2.103 Mrd. €); 2022' },
...
const internationalTabelle: BodyBlock = {
  ...
  _key: key(),
  caption:
    'Zwei gesamtwirtschaftliche Kennzahlen zur Einordnung, bewusst außerhalb des Drei-Maßstäbe-Schemas: Sie beziehen sich nicht auf einzelne Einkommensgruppen, sondern auf das Land insgesamt. Werte aus den jüngsten OECD-Ausgaben (Dezember 2025 und April 2026). Der BMF-Monatsbericht vom August 2025 nannte noch die Vorjahresstände, 47,9 Prozent für 2024 und eine Abgabenquote von 38,1 Prozent für 2023; letztere weist die OECD inzwischen revidiert mit 37,3 Prozent aus. Quelle: OECD, Taxing Wages 2026 und Revenue Statistics 2025 (Länderblätter Deutschland).',
  datensatz: {
    titel: 'Deutschland im internationalen Vergleich',
    quelle: {
      titel: 'OECD — Taxing Wages 2026 und Revenue Statistics 2025 (Länderblätter Deutschland)',
      url: 'https://www.oecd.org/en/publications/taxing-wages-2026_3a5169ef-en.html',
      herausgeber: 'OECD',
    },
    spalten: [
    ...
    daten: [
      { Kennzahl: 'Abgabenquote', Wert: '38,0 %', 'Bezugsgröße und Datenjahr': 'Steuern und Sozialbeiträge in Prozent des BIP; Rang 13 der 38 OECD-Staaten, OECD-Schnitt 34,1 %; 2024 (vorläufig)' },
      { Kennzahl: 'Steuer- und Abgabenkeil', Wert: '49,3 %', 'Bezugsgröße und Datenjahr': 'Anteil an den Arbeitskosten inkl. Arbeitgeberbeiträgen, Alleinstehende mit Durchschnittsverdienst ohne Kinder; zweithöchster Wert der 38 OECD-Staaten, hinter Belgien (52,5 %); 2025' },
    ],
  },
};
...
const steuerDiskurs: BodyBlock = {
  _type: 'diskursBlock',
  _key: key(),
  titel: 'Wie über die Verteilung der Steuerlast gestritten wird',
  frage: 'Wer soll wie viel tragen, und wen soll das Entlastungspaket erreichen?',
  einleitung:
    'Ausgewählt sind die fünf Akteure, die zur Einigung vom Juli 2026 und zum Verteilungs-Check öffentlich Position bezogen haben: die Koalition als Urheberin, die antragstellende Oppositionsfraktion sowie je eine Stimme aus Industrie, Steuerzahlerbund und Sozialverband. Was die vier Datenquellen des Beitrags jeweils messen, steht in den Tabellen und in der Methodik. Paraphrasiert, mit Quelle:',
  perspektiven: [
    {
      label: 'Koalition und Bundesfinanzministerium (2. Juli 2026)',
      aussage:
        'Die Koalition stellt die Einigung unter die Überschrift „mehr Fairness“: Entlastet würden kleine und mittlere Einkommen, insbesondere Familien mit Kindern, mit rund zehn Milliarden Euro im Jahr; im Gegenzug greife der Höchststeuersatz früher, und oberhalb von 280.000 Euro komme ein Satz von 47 Prozent hinzu.',
      quelle: {
        titel: 'BMF — Koalitionsausschuss: Einigung auf Steuerentlastung (2. Juli 2026)',
    ...
    {
      label: 'Fraktion Die Linke (Antrag vom 5. Februar 2026)',
      aussage:
        'Die Fraktion fordert, Verteilungswirkungen jedes Steuergesetzes offenzulegen: aufgeschlüsselt nach Einkommensdezilen sowie für die reichsten 5, 1 und 0,1 Prozent der Haushalte. Aktuell sei nicht ersichtlich, wen ein Gesetz be- oder entlastet; die Methodik der Steuerinzidenz solle veröffentlicht werden.',
      quelle: {
    ...
    {
      label: 'Bundesverband der Deutschen Industrie (6. Juli 2026)',
      aussage:
        'Der BDI kritisiert die Anhebung am oberen Ende: Ein höherer Reichensteuersatz treffe „schätzungsweise zu 70 Prozent unternehmerische Tätigkeiten“; bei Personenunternehmen entstünden effektive Belastungen um 50 Prozent der Gewinne, was Investitionen hemme und die Bildung von Eigenkapital belaste. Die Reform sei allenfalls ein erster Schritt.',
      quelle: {
        titel: 'BDI — Reform der Einkommensteuer: keine Mehrbelastung für den Mittelstand (6. Juli 2026)',
        url: 'https://bdi.eu/de/articles/recht-und-steuern/reform-der-einkommensteuer-keine-mehrbelastung-fuer-mittelstand',
        herausgeber: 'Bundesverband der Deutschen Industrie (BDI)',
      },
    },
    {
      label: 'Bund der Steuerzahler (Präsident Holznagel, 2. Juli 2026)',
      aussage:
        '„Große Koalition, kleine Pläne“: Zehn Milliarden Euro Entlastung im Jahr seien weniger als ein Prozent der Gesamtsteuereinnahmen. Mindestens sechs Milliarden davon wären durch die ohnehin fälligen Schritte bei Grundfreibetrag und Inflationsausgleich verpflichtend gewesen; der Koalitionsausschuss rechne sich sein eigenes Scheitern schön.',
      quelle: {
        titel: 'dpa-Meldung vom 2. Juli 2026 (dokumentiert bei onvista)',
        url: 'https://www.onvista.de/news/2026/07-02-bund-der-steuerzahler-enttaeuscht-ueber-steuerreform-0-10-26528077',
        herausgeber: 'dpa-AFX',
      },
    },
    {
      label: 'Sozialverband VdK (Präsidentin Bentele, 1. Juli 2026)',
      aussage:
        '„Wer die Mitte der Gesellschaft wirklich entlasten will, muss mehr tun, als nur die Einkommensteuer zu senken.“ Kleine Einkommen würden „weniger durch Steuern als durch die steigenden Ausgaben für den täglichen Bedarf überproportional belastet“. Der VdK schlägt vor, die ermäßigte Mehrwertsteuer auf Güter des täglichen Bedarfs auszuweiten, und fordert im eigenen Steuerkonzept höhere Spitzensätze ab niedrigeren Schwellen.',
      quelle: {
        titel: 'VdK-Pressemitteilung vom 1. Juli 2026 (dokumentierte Wiedergabe, Stadtblog Flensburg)',
        url: 'https://akopol.wordpress.com/2026/07/01/vdk-zum-koalitionsausschuss-entlastung-kleiner-und-mittlerer-einkommen-jetzt-umsetzen-aber-richtig/',
        herausgeber: 'Sozialverband VdK',
      },
    },
  ],
  einordnung:
    'Die Positionen spiegeln die Maßstäbe des Beitrags: Die Koalition weist die Entlastung in Euro je Modellhaushalt aus, der Steuerzahlerbund misst sie an den Gesamteinnahmen, der BDI blickt auf die Grenzbelastung unternehmerischer Einkommen, VdK und Linksfraktion auf untere Einkommen, indirekte Steuern und Verteilungstransparenz. Mehrere Dinge sind gleichzeitig richtig: Die Einkommensteuer ist stark progressiv, ein kleiner Teil der Steuerpflichtigen erzielt knapp 30 Prozent der Einkünfte und trägt knapp die Hälfte ihres Aufkommens. Zugleich fällt die Belastung über alle Steuerarten flacher aus, weil indirekte Steuern gut 46 Prozent des Aufkommens ausmachen und untere Einkommen anteilig stärker treffen. Und rechnet man Transfers mit, überwiegen unterhalb der Mitte weitgehend die Leistungen, wie weit hinauf, hängt an der Behandlung der gesetzlichen Rente. Welcher Maßstab der richtige ist, lässt sich nicht empirisch entscheiden: Wer nach Leistungsfähigkeit fragt, kommt zu einem anderen Maßstab als wer nach der Netto-Position im Sozialstaat fragt. Zu bedenken ist außerdem, dass alle Rechnungen auf Annahmen darüber beruhen, wer eine Steuer wirtschaftlich trägt, und dass sie sich auf verschiedene Jahre beziehen.',
};
...
const entlastungTabelle: BodyBlock = {
  ...
  _key: key(),
  caption:
    'So stellt das Bundesfinanzministerium die Wirkung der Entlastung dar: sechs Modellhaushalte, alle mit zwei Kindern. Die Fälle sind ausgewählte Beispiele, keine Verteilungsanalyse über die Bevölkerung. Angegeben ist die geschätzte Entlastung im Jahr 2028, jeweils für ein ganzes Jahr; die Einigung stand im Juli 2026 noch unter dem Vorbehalt des Gesetzgebungsverfahrens. Die letzte Spalte ist eine GURT-Berechnung: die Entlastung als Anteil am Bruttojahreseinkommen (Monatsbrutto mal zwölf). Sie macht sichtbar, was die BMF-Übersicht offenlässt — dass die relativ größte Entlastung dieser sechs Fälle nicht beim höchsten Einkommen ankommt. Für Alleinstehende und Haushalte ohne Kinder nennt die Übersicht keine Werte, ebenso wenig eine Aufschlüsselung nach Einkommensdezilen. Gegen welchen Rechtsstand und mit welcher Annahme zur Lohnentwicklung bis 2028 gerechnet wird, weist die Übersicht nicht aus. Quelle: Bundesfinanzministerium, Einigung des Koalitionsausschusses vom 2. Juli 2026; Prozentwerte GURT.',
  datensatz: {
...
const steuerlastArticle: Article = {
  ...
  ressort: 'finanzen',
  standfirst:
    'Die Einkommensteuer ist stark progressiv: 7,4 Prozent der unbeschränkt Steuerpflichtigen mit zu versteuerndem Einkommen erzielen knapp 30 Prozent der Einkünfte und tragen knapp die Hälfte des Aufkommens. Rechnet man alle Steuerarten zusammen, ist die Belastung nur schwach progressiv und unten sogar regressiv. Rechnet man Transfers mit, sind je nach Behandlung der gesetzlichen Rente die untersten sechs oder nur die untersten drei Einkommenszehntel netto Empfänger; die effektive Grenzbelastung liegt in der Mitte höher als bei hohen Einkommen und ist bei niedrigen Einkommen am höchsten. Alle drei Befunde stimmen, sie messen Verschiedenes. Welcher Maßstab der richtige ist, lässt sich nicht empirisch entscheiden, sondern hängt davon ab, wonach man fragt, und wie folgenreich diese Wahl ist, zeigt sich noch am jüngsten Entlastungspaket.',
  veroeffentlicht: '2026-07-18',
  themen: [
  ...
  autoren: [{ name: 'GURT-Redaktion', rolle: 'Datenjournalismus' }],
  methodik:
    'Einkommensteuer: Statistisches Bundesamt, Lohn- und Einkommensteuerstatistik, Datenjahr 2022 (veröffentlicht Juni 2026; Spitzensteuersatz-Werte aus Pressemitteilung Nr. 194 vom 10. Juni 2026, Gesamtzahl der Steuerpflichtigen, Gesamteinkünfte und Einkommensmillionäre aus den Destatis-Tabellen zum Gesamtbetrag der Einkünfte und zu den Einkommensmillionären): 44 Mio. Steuerpflichtige, Gesamteinkünfte 2.103 Mrd. Euro, 36.530 Einkommensmillionäre; 3,2 Mio. Steuerpflichtige zahlten auf einen Teil ihres Einkommens den Spitzensteuersatz von 42 Prozent (Grenzsteuersatz oberhalb der Schwelle) und trugen bei knapp 30 Prozent der Gesamteinkünfte (621 Mrd. Euro) knapp die Hälfte (49 Prozent) des Einkommensteueraufkommens. Der Anteil von 7,4 Prozent bezieht sich auf die unbeschränkt Steuerpflichtigen mit zu versteuerndem Einkommen, nicht auf alle 44 Millionen ausgewiesenen Steuerpflichtigen; eine Kopfzahl dieser Bezugsgruppe weist Destatis nicht aus. Als Steuerpflichtiger zählt die Statistik einen Steuerfall, bei dem zusammenveranlagte Ehepaare als ein Fall gelten; der Wert ist also kein Personenanteil. Verteilung über alle Steuerarten: DIW Wochenbericht 51+52/2016 (Stefan Bach, Martin Beznoska, Viktor Steiner; gefördert von der gewerkschaftsnahen Hans-Böckler-Stiftung). Die Ergebnisse sind auf 2015 fortgeschrieben, beruhen aber auf älteren Erhebungen: Die für die Regressivität entscheidenden Konsumdaten stammen aus der Einkommens- und Verbrauchsstichprobe 2008, die Einkommensteuerdaten aus 2007/2008. Eine vollständig deckungsgleiche Aktualisierung liegt nicht vor; als neuere, teilweise vergleichbare Arbeit dokumentiert der Beitrag die RWI-Analyse von Isaak, Jäger und Jessen („Die Verteilung der Steuer- und Abgabenlast“, Wirtschaftsdienst 101, 2021, doi.org/10.1007/s10273-021-2896-3; Querschnitt für 2018, SOEP und Einkommens- und Verbrauchsstichprobe, RWI-Mikrosimulationsmodell). Sie rechnet Sozialbeiträge in die Belastung ein, klammert unter anderem die Erbschaftsteuer aus und weist keine nach Steuerarten getrennten Aufkommensanteile aus; ihre Quoten sind deshalb nicht direkt mit den DIW-Anteilen vergleichbar. Nach der DIW-Studie entfallen auf indirekte Steuern 46,3 Prozent des Steueraufkommens; vom obersten Einkommensdezil werden 59 Prozent der direkten Steuern (Einkommensteuer, Solidaritätszuschlag, Unternehmensteuern), 20 Prozent der indirekten Steuern und 42 Prozent der Steuern insgesamt getragen; die Gesamtbelastung wirkt in den unteren Dezilen regressiv. Der Wert „Steuern insgesamt“ ist kein eigener Steuertyp, sondern das gewichtete Mittel der beiden anderen Gruppen. Wichtige Vorbehalte der Studie selbst: Einbehaltene Gewinne der Kapitalgesellschaften sind nicht erfasst, weshalb die Analyse gerade für sehr reiche Haushalte unvollständig ist; insgesamt deckt sie rund 80 Prozent des Steueraufkommens ab (ohne Erbschaftsteuer). Würden einbehaltene Gewinne einbezogen, läge die effektive Einkommensteuerbelastung der obersten Gruppen laut Studie „wohl deutlich niedriger“; für den Aufkommensanteil des obersten Dezils folgt daraus keine eindeutige Richtung. Die Studie weist zudem darauf hin, dass Einkommen und Konsum durch Sparen, Vermögensauflösung oder Verschuldung zeitlich auseinanderliegen können und indirekte Steuern über einen langen Zeitraum betrachtet deshalb weniger regressiv sind, als es der Jahresquerschnitt nahelegt; bei sehr hohen Einkommen, die über den Lebenszyklus Vermögen aufbauen, tritt dieser Effekt nicht ein. Grundsätzlich gilt: Wer eine Steuer wirtschaftlich trägt, ist bei indirekten Steuern und Unternehmensteuern das Ergebnis von Überwälzungsannahmen (Steuerinzidenz) und keine Beobachtung; andere Annahmen führen zu anderen Anteilen. Steuer- und Transfersystem: ifo Institut im Auftrag der CSU-nahen Hanns-Seidel-Stiftung, Studie „Gerechtigkeit für die Mitte?“ (2023, Autoren Dolls, Dorn, Gstrein, Lay, Neumeier), Mikrosimulation mit Rechtsstand 2022 auf Einkommensdaten von 2019, also kein Datenjahr im Sinne einer Erhebung. Danach sind Haushalte unterhalb der Mittelschicht weitgehend Netto-Transferempfänger; die effektive Grenzbelastung liegt bei mittleren Einkommen bei rund 50 Prozent und im Durchschnitt höher als bei hohen Einkommen, am höchsten ist sie bei niedrigen Einkommen, wo 2022 bis zu 80 bis 100 Prozent eines Hinzuverdienstes über Transferentzüge abgeschmolzen wurden. Die Netto-Position beruht auf SOEP-Haushaltsdaten, die genannten Grenzbelastungswerte dagegen auf einer Modellrechnung für einen erwerbstätigen Single-Haushalt (Abbildungen 6 bis 8). Die Studie grenzt die Mittelschicht über das Medianeinkommen ab (75 bis 200 Prozent des Medians); für Alleinstehende entspricht das 2019 einem verfügbaren Jahreseinkommen von rund 17.500 bis 46.600 Euro, für Paare und Familien liegen die Schwellen entsprechend höher. Diese Schichten sind nicht deckungsgleich mit den Einkommensdezilen der übrigen Maßstäbe. Wie weit der Befund „Netto-Transferempfänger“ reicht, hängt von der Behandlung der gesetzlichen Rente ab; die Studie weist alle Varianten aus: als öffentlicher Transfer gezählt sind die untersten sechs Einkommensdezile Netto-Transferempfänger, als Bruttoeinkommen gezählt die untersten drei, ohne Rentnerhaushalte die untersten zwei (Abbildungen 4 und 5). Zwei weitere Vorbehalte der Studie: Gesetzliche Sozialbeiträge erwerben Ansprüche (Rente, Gesundheitsleistungen, Arbeitslosengeld) und sind insofern keiner Steuer gleichzusetzen; Beiträge zur privaten Vorsorge, die bei hohen Einkommen teils an die Stelle der Versicherungspflicht tritt, sind nicht berücksichtigt. Die Einordnung, dass beides den ausgewiesenen Abstand zwischen Mitte und hohen Einkommen vergrößern kann, ist eine eigene. Unterschiedliche Grundgesamtheiten: Destatis zählt je Steuerpflichtigem, DIW und ifo rechnen in Haushaltsdezilen nach bedarfsgewichtetem Einkommen (das Haushaltseinkommen wird durch eine Äquivalenzskala geteilt, um Haushalte unterschiedlicher Größe vergleichbar zu machen); die Werte sind deshalb nicht direkt vergleichbar. Unterschiedlicher Perimeter: Maßstab 2 klammert Sozialbeiträge aus, Maßstab 3 schließt sie ein. Das ist erheblich, weil Sozialbeiträge wegen der Beitragsbemessungsgrenze oberhalb dieser Grenze regressiv wirken. Zu trennen sind außerdem Durchschnittsbelastung (Anteil am Einkommen) und Grenzbelastung (Belastung des zusätzlich verdienten Euro). Internationale Einordnung: OECD Taxing Wages 2026 (April 2026, Länderblatt Deutschland): Steuer- und Abgabenkeil 49,3 Prozent der Arbeitskosten inklusive Arbeitgeberbeiträgen für Alleinstehende mit Durchschnittsverdienst ohne Kinder (2025), Anstieg um 1,34 Punkte gegenüber 47,9 Prozent (2024), zweithöchster Wert der 38 OECD-Staaten hinter Belgien (52,5 Prozent). OECD Revenue Statistics 2025 (Dezember 2025, Länderblatt Deutschland): Abgabenquote 38,0 Prozent des Bruttoinlandsprodukts (2024, vorläufig), Rang 13 von 38 bei einem OECD-Schnitt von 34,1 Prozent. Der BMF-Monatsbericht August 2025 nannte nach damaligem OECD-Stand 47,9 Prozent (2024) und für 2023 eine Abgabenquote von 38,1 Prozent; letztere weist die OECD inzwischen revidiert mit 37,3 Prozent aus. Antrag: Bundestags-Drucksache 21/4004 vom 5. Februar 2026, Fraktion Die Linke; über ihn ist noch nicht entschieden. Entlastungspaket: Bundesfinanzministerium, Einigung des Koalitionsausschusses vom 2. Juli 2026, Volumen rund 10 Mrd. Euro jährlich (unter anderem höherer Grundfreibetrag, Kinderfreibetrag, Kindergeld und Arbeitnehmerpauschbetrag, Spitzensteuersatz ab 70.600 Euro, Reichensteuersatz 45 Prozent ab 250.000 und 47 Prozent ab 280.000 Euro, Abzug für Handwerkerleistungen von 20 auf 15 Prozent gesenkt, Pauschsteuer auf Minijobs von 2 auf 5 Prozent erhöht); zum Redaktionsstand im Juli 2026 noch nicht in Gesetzgebung umgesetzt. Schuldner der Minijob-Pauschsteuer ist nach § 40a in Verbindung mit § 40 Absatz 3 des Einkommensteuergesetzes der Arbeitgeber; eine Belastung der Beschäftigten setzt Überwälzung voraus. Die Entlastungsbeträge sind Jahreswerte für 2028 im Vergleich zu heute und beziehen sich auf sechs Modellhaushalte mit je zwei Kindern; das BMF weist dort keine Werte für Alleinstehende oder Haushalte ohne Kinder und keine Aufschlüsselung nach Einkommensdezilen aus. Gegen welchen Rechtsstand die Entlastung gerechnet ist und welche Annahme zur Lohnentwicklung bis 2028 zugrunde liegt, nennt die Übersicht nicht; bei einem Mehrjahresvergleich beeinflusst gerade dies die Höhe. Die von GURT ausgewiesenen Prozentwerte setzen die Entlastung ins Verhältnis zum Bruttojahreseinkommen (Monatsbrutto mal zwölf); der Vergleich „in absoluten Euro mehr, gemessen am Einkommen weniger“ ist eine eigene Einordnung auf Basis dieser Werte. Debattenstimmen im Diskursteil: Koalition/BMF (2. Juli 2026), Fraktion Die Linke (BT-Drs. 21/4004), BDI (6. Juli 2026), Bund der Steuerzahler (dpa-Meldung vom 2. Juli 2026, dokumentiert bei onvista), Sozialverband VdK (Pressemitteilung vom 1. Juli 2026, dokumentierte Wiedergabe); Belege an den jeweiligen Stimmen. Online-Quellen im Juli 2026 abgerufen.',
  body: [
    block('h2', 'Worum es geht'),
    block(
      'normal',
      'Wenn über Steuern gestritten wird, stehen sich zwei Erzählungen gegenüber: Die einen sagen, Spitzenverdiener trügen ohnehin den Löwenanteil. Die anderen sagen, untere und mittlere Einkommen zahlten anteilig zu viel. So zugespitzt ist das eine typisierende Zusammenfassung; wer diese Positionen konkret vertritt, steht mit Belegen am Ende des Beitrags. Beide Seiten berufen sich auf echte Zahlen. Der Grund ist, dass sie unterschiedliche Dinge messen. Dieser Beitrag legt drei gängige Maßstäbe nebeneinander und zeigt, was jeder von ihnen erfasst und was nicht.',
    ),
    block('h2', 'Erster Maßstab: die Einkommensteuer allein'),
    block(
      'normal',
      'Betrachtet man nur die Einkommensteuer, ist das Bild eindeutig. Nach der Lohn- und Einkommensteuerstatistik des Statistischen Bundesamts für das Jahr 2022 zahlten 3,2 Millionen Steuerpflichtige auf einen Teil ihres Einkommens den Spitzensteuersatz von 42 Prozent; er ist ein Grenzsteuersatz und gilt nur für den Einkommensteil oberhalb der Schwelle. Das sind 7,4 Prozent aller unbeschränkt Steuerpflichtigen mit zu versteuerndem Einkommen. Auf diese Gruppe entfielen knapp 30 Prozent der Gesamteinkünfte (621 von 2.103 Milliarden Euro), aber knapp die Hälfte (49 Prozent) des Einkommensteueraufkommens. Erst dieses Verhältnis zeigt die Progression: Der Aufkommensanteil allein sagt noch nicht, ob eine Gruppe gemessen an ihrem Einkommen viel oder wenig trägt. Insgesamt weist die Statistik 44 Millionen Steuerpflichtige aus, darunter 36.530 mit einem Gesamtbetrag der Einkünfte von einer Million Euro und mehr. Ein Steuerpflichtiger ist dabei ein Steuerfall: Zusammenveranlagte Ehepaare zählen als einer.',
    ),
    kennzahlenTabelle,
    ...
    block(
      'normal',
      'Drei Einschränkungen sind wichtig. Erstens ist die Datenbasis alt: Die Ergebnisse sind zwar auf 2015 fortgeschrieben, die für die Regressivität entscheidenden Konsumdaten stammen aber aus der Einkommens- und Verbrauchsstichprobe von 2008. Eine vollständig deckungsgleiche Aktualisierung liegt nicht vor; eine neuere, teilweise vergleichbare Analyse des RWI mit Daten von 2018 (Isaak, Jäger, Jessen) verbindet ebenfalls SOEP und Einkommens- und Verbrauchsstichprobe, rechnet aber Sozialbeiträge in die Belastung ein und weist keine nach Steuerarten getrennten Aufkommensanteile aus, ist also nicht direkt mit den DIW-Werten vergleichbar. Zweitens ist die Aufteilung keine Beobachtung, sondern eine Rechnung: Wer indirekte Steuern und Unternehmensteuern wirtschaftlich trägt, hängt von Überwälzungsannahmen ab. Die Studie selbst hält fest, dass einbehaltene Unternehmensgewinne nicht erfasst sind und ihre Aussagen deshalb gerade für sehr reiche Haushalte unvollständig bleiben. Drittens gilt die Rechnung für ein einzelnes Jahr. Die Studie weist selbst darauf hin, dass Einkommen und Konsum zeitlich auseinanderliegen können, durch Sparen, Vermögensauflösung oder Verschuldung, und dass indirekte Steuern über einen langen Zeitraum betrachtet deshalb weniger regressiv sind, als es der Jahresvergleich nahelegt. Bei sehr hohen Einkommen, die über den Lebenszyklus dauerhaft Vermögen aufbauen, tritt dieser Ausgleich laut Studie allerdings nicht ein.',
    ),
    block('h2', 'Dritter Maßstab: Steuern und Transfers zusammen'),
    block(
      'normal',
      'Ein drittes Bild ergibt sich, wenn man nicht nur fragt, wer zahlt, sondern auch, wer empfängt. Eine Studie des ifo Instituts im Auftrag der CSU-nahen Hanns-Seidel-Stiftung hat 2023 das gesamte Steuer- und Transfersystem für den Rechtsstand 2022 durchgerechnet, auf Einkommensdaten von 2019. Danach sind Haushalte unterhalb der Mittelschicht weitgehend Netto-Transferempfänger: Sie erhalten mehr Leistungen, als sie an Steuern und Sozialabgaben zahlen. Wie weit dieser Befund reicht, hängt allerdings an einer Konvention. Zählt man die gesetzliche Rente als öffentlichen Transfer, sind die untersten sechs Einkommenszehntel netto Empfänger; zählt man sie als Einkommen, nur die untersten drei; lässt man Rentnerhaushalte ganz außen vor, die untersten zwei. Nach dieser Studie tragen die Mittelschicht und die hohen Einkommen die Umverteilung netto.',
    ),
    block(
      'normal',
      'Auffällig ist ein zweiter Befund, den die Studie an einer Modellrechnung für einen erwerbstätigen Single-Haushalt zeigt: Von einem zusätzlich verdienten Euro bleiben in der Mitte effektiv nur rund 50 Prozent, und diese effektive Grenzbelastung liegt dort im Durchschnitt höher als bei hohen Einkommen. Am höchsten ist sie allerdings bei niedrigen Einkommen: Dort wurden 2022 bis zu 80 bis 100 Prozent eines Hinzuverdienstes über wegfallende Transfers wieder abgeschmolzen. Zu beachten ist auch, dass dieser Maßstab Sozialbeiträge einschließt, die der zweite Maßstab ausklammert. Die Studie nennt dazu selbst zwei Vorbehalte: Sozialbeiträge erwerben, anders als Steuern, Ansprüche auf Rente, Gesundheitsleistungen und Arbeitslosengeld; und Beiträge zur privaten Vorsorge, mit der hohe Einkommen teils von der Versicherungspflicht befreite Risiken absichern, sind im Modell nicht enthalten. Beides kann den ausgewiesenen Abstand zwischen Mitte und hohen Einkommen größer erscheinen lassen, als er bei voller Rechnung wäre. Was in der Studie „Mittelschicht“ heißt, ist über das Medianeinkommen abgegrenzt und nicht deckungsgleich mit den Einkommensdezilen der anderen Maßstäbe; die Grenzen stehen in der Methodik.',
    ),
    massstabTabelle,
    block(
      'normal',
      'Zur Einordnung, wie Deutschland insgesamt dasteht, kommen zwei gesamtwirtschaftliche Kennzahlen hinzu. Sie gehören bewusst nicht zu den drei Maßstäben, weil sie nicht einzelne Einkommensgruppen messen, sondern das Land als Ganzes: die Abgabenquote und den Steuer- und Abgabenkeil. Nach der jüngsten OECD-Ausgabe ist der Abgabenkeil zuletzt deutlich gestiegen, von 47,9 Prozent im Jahr 2024 auf 49,3 Prozent im Jahr 2025; Deutschland bleibt damit hinter Belgien das OECD-Land mit dem zweithöchsten Wert.',
    ),
    ...
    block(
      'normal',
      'Über den Antrag der Oppositionsfraktion war bis zum Redaktionsschluss im Juli 2026 nicht entschieden. Er würde die Maßstabsfrage auch nicht beantworten, sondern nur festlegen, welche Größe künftig auszuweisen wäre. Und das Ergebnis eines solchen Verteilungs-Checks hinge von eben den Überwälzungsannahmen ab, an denen sich die vorliegenden Studien unterscheiden. Wie heikel dieser Punkt ist, zeigt der Antrag selbst: Er verlangt zusätzlich, die Methodik der Steuerinzidenz offenzulegen.',
    ),
    block('h2', 'Welche Verteilungsangaben das Entlastungspaket liefert'),
    block(
      'normal',
      'Kurz nach dem Antrag lieferte die Regierung selbst eine Verteilungsdarstellung, wenn auch in anderer Form. Am 2. Juli 2026 einigte sich der Koalitionsausschuss auf ein Entlastungspaket von rund zehn Milliarden Euro im Jahr: höherer Grundfreibetrag, höherer Kinderfreibetrag, mehr Kindergeld, höherer Arbeitnehmerpauschbetrag, ein später greifender Spitzensteuersatz ab 70.600 Euro, dazu ein früher greifender Höchststeuersatz von 45 Prozent (ab 250.000 statt bisher rund 278.000 Euro) und ein neuer Satz von 47 Prozent ab 280.000 Euro, ein geringerer Abzug für Handwerkerleistungen und eine von zwei auf fünf Prozent steigende Pauschsteuer auf Minijobs. Die Einigung ist eine politische Verständigung der Koalition, noch kein Gesetz; die Werte stehen unter dem Vorbehalt des Gesetzgebungsverfahrens. Das Bundesfinanzministerium legte dazu offen, wen die Entlastung wie stark treffen soll.',
    ),
    entlastungTabelle,
    block(
      'normal',
      'Auch diese Darstellung trifft eine Maßstabsentscheidung. Die Übersicht rechnet mit sechs Modellhaushalten, die alle zwei Kinder haben; Alleinstehende und Haushalte ohne Kinder kommen darin nicht vor, und statt nach Einkommensdezilen ordnet sie nach Berufsbildern. Auch die beiden Maßnahmen, die nicht entlasten, sondern belasten, tauchen in der Tabelle nicht auf: der früher greifende Höchststeuersatz am oberen Ende und die höhere Pauschsteuer auf Minijobs. Bei letzterer ist zudem offen, wen sie am Ende trifft: Schuldner der Pauschsteuer ist der Arbeitgeber. Ob sie auf die Beschäftigten überwälzt wird, ist eine Annahme, wie bei allen Überwälzungsfragen dieses Beitrags.',
    ),
    block(
      'normal',
      'Hinzu kommt, dass die Beträge, aufs Jahr und aufs Einkommen bezogen, nah beieinander liegen. Ein Paar mit 5.600 Euro brutto im Monat, gut 67.000 Euro im Jahr, wird 2028 um rund 632 Euro entlastet, das sind 0,9 Prozent seines Bruttoeinkommens. Ein Paar mit 10.000 Euro im Monat erhält 678 Euro, aber nur 0,6 Prozent. In absoluten Euro bekommt der besserverdienende Haushalt also etwas mehr, gemessen am Einkommen weniger. Unter den sechs Beispielhaushalten wird, gemessen am Einkommen, die alleinerziehende Pflegekraft mit dem niedrigsten Einkommen am stärksten entlastet: Für sie sind 468 Euro 1,4 Prozent. Ob diese Reihenfolge für die Bevölkerung insgesamt gilt, lässt sich aus sechs ausgewählten Beispielen nicht ableiten. Welcher der Vergleiche der aussagekräftigere ist, entscheidet wieder der Maßstab, und die Übersicht legt sich darauf nicht fest.',
    ),
    block('h2', 'Wie über die Verteilung gestritten wird'),
    block(
      'normal',
      'Mit der Einigung vom Juli 2026 und dem Antrag der Linksfraktion ist die Maßstabsfrage konkret geworden. Die folgenden Stimmen decken Regierungskoalition, Opposition, Industrie, Steuerzahlerbund und Sozialverband ab; was die vier Datenquellen des Beitrags jeweils messen, steht in den Tabellen oben und in der Methodik.',
    ),
    steuerDiskurs,
    {
      _type: 'quellenNote',
      _key: key(),
      text: 'Daten: Statistisches Bundesamt, Pressemitteilung Nr. 194 vom 10. Juni 2026 sowie Tabellen zur Lohn- und Einkommensteuerstatistik 2022 (Gesamtbetrag der Einkünfte; Einkommensmillionäre). DIW Wochenbericht 51+52/2016 (Bach, Beznoska, Steiner; gefördert von der gewerkschaftsnahen Hans-Böckler-Stiftung; auf 2015 fortgeschrieben, Konsumdaten aus der Einkommens- und Verbrauchsstichprobe 2008): Anteile am Steueraufkommen und Belastungsverlauf je Dezil. Als neuere, teilweise vergleichbare Arbeit dokumentiert: Isaak, Jäger, Jessen (RWI), „Die Verteilung der Steuer- und Abgabenlast“, Wirtschaftsdienst 101 (2021), Querschnitt für 2018. ifo Institut im Auftrag der CSU-nahen Hanns-Seidel-Stiftung, „Gerechtigkeit für die Mitte?“ (2023; Mikrosimulation, Rechtsstand 2022, Einkommensdaten 2019): Netto-Position und Grenzbelastung. OECD, Taxing Wages 2026 und Revenue Statistics 2025 (Länderblätter Deutschland): Abgabenkeil 2025 und Abgabenquote 2024; der BMF-Monatsbericht August 2025 dokumentiert den früheren Stand. Antrag: Bundestags-Drucksache 21/4004 vom 5. Februar 2026 (Fraktion Die Linke), aus der auch das wörtliche Zitat stammt; über den Antrag war bis Juli 2026 nicht entschieden. Entlastungspaket und Modellhaushalte: Bundesfinanzministerium, Einigung des Koalitionsausschusses vom 2. Juli 2026, zum Redaktionsstand noch nicht in Gesetzgebung umgesetzt; die Prozentwerte der Entlastungstabelle sind eine eigene Berechnung. Beide Verteilungsstudien sind Auftrags- beziehungsweise Drittmittelarbeiten mit erkennbarer Nähe zu unterschiedlichen politischen Lagern. Die drei Maßstäbe sind nicht ineinander umrechenbar; Grundgesamtheiten, Perimeter, Inzidenzannahmen und Bezugsjahre siehe Methodik.',
      quelle: {
