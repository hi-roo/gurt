...
const integrationArticle: Article = {
  ...
  body: [
    ...
    integrationDiskurs,
    {
      _type: 'quellenNote',
      _key: key(),
      text: 'Arbeitsmarktzugang: BMAS und Bundesagentur für Arbeit. Erwerbstätigenquoten nach Geburtsland: Eurostat (lfsa_ergacob, 2024). Ukrainische Geflüchtete im Ländervergleich: IAB-Forschungsbericht 16/2024 (nur eingeschränkt vergleichbar — Methoden- und Datenstand-Hinweise siehe Methodik). Positionen paraphrasiert nach IAB, Bundesregierung/Bundesagentur für Arbeit, DGB, Informationsverbund Asyl & Migration und OECD. Der Beitrag geht auf einen Leserhinweis zurück.',
